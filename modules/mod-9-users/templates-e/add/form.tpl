<form class="w-100" action="{c2r-mdl-url}add/" method="post" name="form" id="form" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col taright">
			<button type="submit" class="btn btn-save btn-success btn-action" name="save" id="save"><i class="fas fa-save" aria-hidden="true"></i><span class="block all-15"></span>{c2r-btn-save}</button>
